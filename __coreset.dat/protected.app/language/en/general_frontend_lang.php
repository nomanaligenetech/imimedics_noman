...
$lang['label_dedication_gift'] = "Dedication </br> We’ll send an e-card to commemorate your gift";
...
$lang['label_arbaeen_form_phone_note'] = "Please select the country code and list your phone number below (Whatsapp number preferred).";
...
$lang['label_arbaeen_form_address_note'] = "Please include your address if you have moved since your last application or at minimum your country of residence  (impacts travel, tickets, visas etc).";
$lang['label_arbaeen_form_role_note'] = "Non-health professionals/students/translators/helpers should apply for Admin category.";
$lang['label_arbaeen_form_citizenship'] = "Citizenship";
$lang['label_arbaeen_form_deposit'] = "Deposit";
$lang['label_arbaeen_form_amount_deposit'] = "$100 Deposit";
...
$lang['label_arbaeen_form_how_old'] = "How old will you be at the start of the trip?";
...
$lang['label_arbaeen_form_health_his'] = "Please include brief information below regarding any health history/current conditions/allergies AND your personal physical & mental fitness self-assessment for this trip.";
...
$lang['text_understand_med_camp'] = "I understand that i am applying to serve in a medical mission and that service will be my priority";
...
$lang['label_othername'] = "Name you prefer to be called by others (if not your legal name)";
$lang['label_role'] = "What type of role are you applying for?";
...
$lang['text_membership_useformbelow_msg2'] = "If you have any questions, please contact IMI HQ at 609-913-0013 or via email at <a href='mailto:imihq@imamiamedics.com'>imihq@imamiamedics.com</a>.";
...
$lang['text_profile_welcome_msg'] = "Welcome to your profile on IMI’s new website. From this panel, you’ll be able to access your basic details, view donations/payments made as well as manage your membership dues. We’re in the process of uploading details for more than 20,000 people so please bear with us and we’ll have your finance details up shortly.<br/><br/>Membership details for dues paying IMI Canada, IMI US, and IMI UK members have been uploaded and you can view your status under your Profile and Membership History. We urge all to update your details under your profile and, for those who are not dues-paying members as yet, we encourage you to sign up as a dues paying member today!";
...
$lang['text_passportcopyupload'] = "Passport Copy Upload (Color copy with all text easily readable)";
...
$lang['success_page_heading'] = "You’re what making a difference looks like";
$lang['donte_form_heading'] = 'Donate to %s';
if ( is_countryCheck(FALSE,FALSE,TRUE) == 'medics' ){
    $lang['donte_form_text'] = 'You can easily donate by using our secure online payment portal or send your donation via Zelle to <a href="mailto:Mi@medicsinternational.org">Mi@medicsinternational.org</a> or Venmo us at @medicsinternational';
} else {
...
$lang['text_cvresumeupload_note'] = "Please upload your current CV or resume here.";
$lang['text_choosefileanddrag'] = "Choose files or drag here";
$lang['text_PERSONALCONVENANT'] = "PERSONAL COVENANT AND LIABILITY RELEASE FORM—affirmative acceptance and signature required (on online form)";
...
$lang['text_theguidlineslistedbelow_cond_1'] = "To strictly adhere to ALL IMI protocols and guidelines (ranging from infection control to IMI governance).";
$lang['text_theguidlineslistedbelow_cond_2'] = "This is a medical mission and not a ziyarat group.";
$lang['text_theguidlineslistedbelow_cond_3'] = "This is a general medical camp—i.e. the majority of cases include flu, body aches, sores, contraceptive needs, etc. and is not extremely specialized. In some instances, as needed, specialists MAY be called on to perform services at hospitals but that is NOT the core of work.";
$lang['text_theguidlineslistedbelow_cond_4'] = "Any future activities resulting from my time in Iraq and/or involvement in the mission or with IMI, must be reported to IMI (via IMI HQ) to be coordinated through the relevant body in IMI (as directed in further communication).";
$lang['text_theguidlineslistedbelow_cond_5'] = "All delegates represent IMI in the field however, I do not have the authority to make assurances of any additional plans/work on behalf of IMI (unless specifically discussed).";
$lang['text_theguidlineslistedbelow_cond_6'] = "This medical mission, despite precautions and risk mitigation protocols by IMI, includes an assumption of risk of contracting COVID 19.";
...
$lang['text_theguidlineslistedbelow_9'] = "Attend all team meetings possible—including those prior to, during, and after the trip.";
...
$lang['text_theguidlineslistedbelow_18'] = "Work diligently at my placement location and understand that this mission is an intense work experience.";
$lang['text_theguidlineslistedbelow_19'] = "Work as required including additional shifts or responsibilities that may arise due to changes on the ground.";
$lang['text_theguidlineslistedbelow_20'] = "Work with professionalism which includes appropriate well mannered engagement with ALL staff, volunteers and patients as well as being on time for my shift.";
$lang['text_theguidlineslistedbelow_21'] = "Acknowledge that during this journey, I am subjecting myself to certain risks voluntarily, including and in addition to those risks that I normally face in my personal and business life, including, but not limited to such things as health hazards due to poor food and water, diseases, pests, and poor sanitation; potential danger from lack of control of the local population; potential injury while working; and inadequate medical facilities.";
$lang['text_theguidlineslistedbelow_22'] = "I understand that travel, especially to remote locations, can be uncomfortable and sometimes difficult, and I promise to adopt a flexible attitude and be supportive as plans may need to be changed. I understand that I must travel with the rest of the team, unless other prior arrangements are made.";
$lang['text_theguidlineslistedbelow_23'] = "I agree that in the event that my conduct is considered so unsatisfactory that it jeopardizes the success of the trip, and that counseling or mediation during the trip has failed to correct my behavior, that my services in connection with this trip shall end, and I shall return home immediately at my own expense.";
$lang['text_theguidlineslistedbelow_24'] = "I release all photographs, videos and digital media and consent that these may be used in any manner based on IMI’s discretion.";
...
$lang['text_doctor'] = "Doctor";
$lang['text_nurse'] = "Nurse";
$lang['text_pharm'] = "Pharm";
$lang['text_dental'] = "Dental";
$lang['text_admin'] = "Admin";
$lang['text_accompanying_family'] = "Accompanying Family";
$lang['text_application'] = "Application for:";
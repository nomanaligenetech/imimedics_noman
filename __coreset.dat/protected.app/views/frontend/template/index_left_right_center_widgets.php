        ...
        <div class="cont2">
            <div class="inner_content bg_Offwhite p_TopBottom30">
                <div class="cont1 Two_Col_Tem1">
                    ...
                    <div class="right_area cmsarea fl_rit w_68">
                        ...
                        <div class="Temp3_Wrap w_100">


                            <div class="Temp3_cols Temp_Right_Left w_65 fl_lft">

                                <?php
								foreach ($center_widgets as $cw) {
										switch ($cw['widget_id']) {
											case "chapterlocations":
												$TMP_chapterlocations			= array(
													"slug"				=> false,
													"readmore"			=> true
												);
												$this->load->view("frontend/template/widgets/chapterlocations", $TMP_chapterlocations);
												break;
							...
							foreach ($right_widgets as $rw) {
									$TMP_widget				= right_widgets($rw['widget_id'], "all");

									$TMP_widget['data']['name'] = "chapterlocations";

									$this->load->view($TMP_widget['widgetpage'], $TMP_widget['data']);
								}
							?>
                    ...
                    <div class="template_left fl_lft w_30">
						...
						foreach ($left_widgets as $lw) {
								switch ($lw['widget_id']) {
									case "testimonials":
										$this->load->view("frontend/template/widgets/testimonials");
										break;

									case "getinvolved":
										$this->load->view("frontend/template/widgets/getinvolved");
										break;

...
<div class="formarea">
  <div class="abstract-form-content">
    ...
    <table cellpadding="2" cellspacing="5" width="100%" class="semiform tableform" >
        ...
        <?php
		if ( $total_family_registrations > 0 )
		{
			?>
            	<tr>
                ...
                <tr>
                	<td colspan="2" align="center" style="text-align:center">
                    	<strong><?php echo $total_family_registrations;?> family members accompanying you. Please register them all.</strong>
                    </td>
                </tr>
                <tr>
                  <td>&nbsp;</td>
                ...
                <tr>
                  <td><a style="text-decoration:underline;">Family Registration # <?php echo $family_registered_no;?></a></td>
                  <td>&nbsp;</td>
                </tr>
            <?php	
		}
        ...
        <tr>
          ...
          <td>
            ...
            class="<?php echo set_class( $tmp_name );?>" value="m"  <?php echo set_checkbox($tmp_name, 'm');?>  />
            Male
            </label>
            ...
            <input type="radio" name="<?php echo $tmp_name;?>" 
            class="<?php echo set_class( $tmp_name );?>" value="f"  <?php echo set_checkbox($tmp_name, 'f');?>  />
            Female
            </label>
		...
		?>
        		<tr>
                    <td>Will attend conference? <?php echo required_field();?></td>
                    <td>
                    <?php
                    $tmp_name			= 'will_attend_conference';
                    ?>
                    <label>  
                        <input type="radio" name="<?php echo $tmp_name;?>" 

...
if ( ! $this->validations->is_conference_registration_expired( FALSE ) || TRUE )
{
?>
	<p>&nbsp;</p>
    ...
    <div class="int-part-tab <?php echo (@SessionHelper::_get_session("regionid", "conferenceregistration")=="16")?" iraqian_table":""?>">
        <div class="int-part-lefttab">
            ...
            <div class="gradiansection">
                <div class="gradianshadow"> Conference Registration, Fees & Tickets </div>
            </div>
            ...
            <div class="reg-table">
                ...
                if ( count($prices_chart['members']['all']) > 0 )
                {
                    ...
                    {
						#if ( $p[  $first_key  ]['earlybird_pricedisplay'] != "$0.00" )
						#{
						
						if ( $p[  $first_key  ]['earlybird_price'] > 0 )
						{
                        ?>
                            <div class="table-row3">
                                ...
                                <div class="row1-col3"> 
								<?php 
								echo $p[  $first_key  ]['earlybird_pricedisplay'];
								?> 
                                </div>
                                <div class="row1-col4"> &nbsp; </div>
    ...
    <div class="alng-mid">
        <a href="<?php echo site_url( "conference/" . $conference->row("slug") . "/registration/screen/1" );?>" style="text-decoration:none">
            <input class="bluebuttons" type="button" value="To register for the <?php echo $conference->row("name");?>, please click here" />
        </a>
    </div>
<?php
}
...
<style>
.reg-table .row1-col3, .reg-table .row1-col5{ height:70px;}
</style>
...
<div class="screentwo_information pak_step-information">

<table width="100%" border="0" bgcolor="f7f7f7" cellspacing="0" cellpadding="0" class="firsttable pak_step-information-registrant">
            <tr>
            	<td></td>
            </tr>
            
            <tr class="pak_step-registrant-heading">
                <td width="5%">&nbsp;</td>
...
<table width="100%" bgcolor="f7f7f7" border="0" cellspacing="0" cellpadding="0" class="secondtable pak_step-information-family">
		...
		?>
        	<tr class="pak_step-registrant-heading">
                ...
                <h1>
                    ...
                    {
                        ?>
                        Family Guest / Person Information
                        <?php
                    }
                    else
                    {

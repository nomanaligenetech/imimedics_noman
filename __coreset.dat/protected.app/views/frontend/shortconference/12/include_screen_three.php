<table cellpadding="2" cellspacing="5" width="100%" class="semiform tableform" >
        ...
        <tr>
            ...
            <small>
            <em>(Upload a photo for your visa application.  <br /><strong>Please note:</strong> women's photographs must include scarves/head coverings for visa photos for Pakistan)</em>
            </small>
            </td>
            <td>
        ...
        <tr>
          <td>Number of Previous Travels to Pakistan <?php echo required_field();?></td>
          <td><?php
        ...
        <tr>
          <td>The Last Date of Entry to Pakistan [date you left Pakistan last time] <?php  required_field();?></td>
          <td><?php
        ...
        <tr>
          <td>Date of Departure from Pakistan after conference <?php echo required_field();?></td>
          <td><?php

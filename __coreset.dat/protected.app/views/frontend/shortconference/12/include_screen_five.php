...
if ( $conferenceregistration_screenone -> row("travelling_with") != "independently" || true) //for 10th conf. it will always show Accommodation Planner
{
                    ...
                    if ( $family_records -> num_rows() > 0 )
                    {
                        ...
                        <tr bgcolor="#efefef" class="tr_applyforsame">
                          <td class="tableborderhide" colspan="8" align="center" height="25">
							...
							{
								?>
								Accompanying Family Members / Persons
								<?php
							}
							else
							{
            ...
            <table class="table" width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  ...
                  <th width="16%" align="left" scope="col">To</th>
					...
					{
					?>
               	  	<th width="48%" align="left" class="hidethistr" scope="col">
                    In case all 
                    <?php 
                    if ( is_conference_registered_for_local() )
                    {
                    ...
                    ?>                      
                    are not accompanying, name and age of those will travel by air
                  	</th>
		      <?php
					}
					?>
	...
	?>
        ...
        <table class="table" width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <th width="29%" align="left" scope="col">
            Name, address and phone number of friend / 
			<?php 
            if ( is_conference_registered_for_local() )
            {
                ?>
...
<?php 
//CMS - Important Content
if ( is_object($important_content) )
{
	if ( $important_content->num_rows() > 0 )
	{

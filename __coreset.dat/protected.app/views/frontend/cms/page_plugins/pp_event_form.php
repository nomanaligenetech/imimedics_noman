            ...
            <div class="form_sec fl_lft w_100 custom-border">
                <form name="form_event_register" action="<?php echo site_url(uri_string()); ?>" id="form_event_register" method="post" enctype="multipart/form-data" novalidate>
                                ...
                                ?>
                                    <label class="package-item">
                                        ...
                                        <div class="pakcage-detail">
                                            <!-- <span class="pakcage-seat"><?php // echo $e_v->available_seats; 
                                                                            ?></span> -->
                    ...
                    <div class="personal-info">
                        ...
                        <!-- <p style="text-align: center;"><?php //echo lang_line('donte_form_text'); 
                                                            ?></p> -->
                        <!-- <input type="hidden" value="<?php //echo $this->payment->paypal_form_details()->business_email; 
                                                            ?>" name="business">
                            <input type="hidden" value="USD" name="currency_code">
                            <input type="hidden" value="<?php //echo $this->functions->_user_logged_in_details("id"); 
                                                        ?>" name="item_number"> -->
                    ...
                    <div class="flALlLeft customclass less-class cutsom-margin-style">
                        <div class="col-sm-6 paddRzERo ">
                            <?php if ($is_package) :
                                $placeholder = "$ 0.00";
                            ?>
                                <!-- <label class="fl_lft m_bottom5 m_rite10">Fees will be calculated before you place your order. <?php //echo lang_line('label_pay_paypal'); 
                                                                                                                                    ?></label> -->
                    ...
                    <div class="flALlLeft col-sm-12  m_bottom10 custom_style1">
                        <label class="fl_lft m_bottom5 m_rite10" <?php /*if(!isset($_GET['testing'])){ echo 'style="display:none;"';}*/ ?>>
                                ...
                                echo form_radio(array('name' => 'paymenttype', 'value' => 'card', 'checked' => TRUE, 'id' => 'card'));

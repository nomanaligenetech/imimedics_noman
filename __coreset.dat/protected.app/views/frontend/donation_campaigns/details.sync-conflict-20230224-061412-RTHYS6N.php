...
if( site_url() == "https://imicanada.org/"){
    ...
    $payment_email_address = $this->payment->paypal_form_details()->business_email;
    $payment_text          = 'You can easily donate by using our secure online payment portal or send your donation via Zelle, Venmo or PayPal to '. $this->payment->paypal_form_details()->business_email;
    $if_can = false;
}
?>

                ...
                ?>
                    <tr>
                        ...
                        <a href="<?php echo site_url( $_directory . "controls/edit/" . $row["id"]);?>">
                            <input type="button" data-operationid="csvmemberdataedit" class="btn btn-success btn-sm" value="<?php echo lang_line("text_edit");?>"  />
                        </a>
                        </td>
                    </tr>
                <?php
...
?>
    ...
    <div class="crud_controls">
        ...
        <a href="<?php echo site_url( $_directory . "controls/add" );?>" data-operationid="csvmemberdataadd">
        	<input data-operation="add" type="button" class="btn btn-warning btn-flat submit_btn_form" value="<?php echo lang_line("text_add");?>"  />
        </a>
        <input data-operation="delete" data-operationid="csvmemberdatadelete" type="button" class="btn btn-danger btn-flat submit_btn_form" value="<?php echo lang_line("text_delete");?>" />

                ...
                ?>
                    <tr>
                        ...
                        <td>
                        	...
                        	<?php echo $this->load->view("admincms/manageshortconferenceregistrationfinance/12/view_registration_prices", array('fetch_records_for_view_ROW' => $row)); ?>
						...
						if ( $row["travelling_with"] == 'independently'  and $row['VIEW_screen_5'] )
						{
                            ...
                            onclick="_runtimePopup('modalUrl_80perc', '<?php echo site_url( "admincms/manageshortconferenceregistrationfinance/controls/display_screen_5/" . $row["id"] );?>')" 
                            href="javascript:;" >

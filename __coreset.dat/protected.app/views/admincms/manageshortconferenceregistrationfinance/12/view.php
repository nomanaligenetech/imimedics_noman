...
<table class="table table_form">
        ...
        <tr>
          <td class="td_bg"><strong>UID </strong></td>
          <td class="td_bg" colspan="2">
          	<div class="input-group">
		    <?php
			echo '<span class="input-edit-details">'. generate_participant_UID( set_value("id", $id )).'</span>';
			?>
		    </div>
		...
		?>
            <tr>
                ...
                <td class="td_bg fieldValue" colspan="2">
                    <?php echo $this->load->view("admincms/manageshortconferenceregistrationfinance/12/view_registration_prices"); ?>
                </td>
            </tr>

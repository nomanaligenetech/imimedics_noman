            ...
            foreach ( $table_record -> result_array() as $key => $row )
            {
                ...
                ?>
                    <tr>
                        ...
                        <td>
						<?php 
						$TMP_child			 = $this->queries->fetch_records("chapterpersons_details", " AND parentid = '". $row['id'] ."' ");
						if ( $TMP_child -> num_rows() > 0 )
						{
							$arr			 = "<ul>";
							foreach ( $TMP_child->result_array() as $tc )
							{
								$arr		.= "<li>" . $tc['board_name'] . "</li>";
							}
							$arr			.= "</ul>";
                        ...
                        <td>
                        <a href="<?php echo site_url( $_directory . "controls/edit/" . $row["id"]);?>" data-operationid="managechapterpersonsedit">
...
?>
    ...
    <div class="crud_controls">
        ...
        <a href="<?php echo site_url( $_directory . "controls/add" );?>" data-operationid="managechapterpersonsadd">
        	<input data-operation="add" type="button" class="btn btn-warning btn-flat submit_btn_form" value="<?php echo lang_line("text_add");?>"  />
        </a>
        <input data-operation="delete" data-operationid="managechapterpersonsdelete" type="button" class="btn btn-danger btn-flat submit_btn_form" value="<?php echo lang_line("text_delete");?>" />
        
        
        <a href="javascript:;" data-operationid="managechapterpersonsupdatesorting">

            ...
            foreach ( $table_record  as $key => $row )
            {
                ...
                ?>
                    <tr>
                        ...
                        <td><?php echo ($row["campaign"] ? "Yes" : "No");?></td>
                        <td><?php echo DropdownHelper::cmsmenubelongsto_dropdown(false, $row["belongsto"]);?></td>
                        <td><?php echo getUserNameByID($row["added_by"]);?></td>
                        <td>
                        <a href="<?php echo site_url( $_directory . "controls/edit/" . $row["id"]);?>" data-operationid="managedonationprojectsedit">
...
?>
    ...
    <div class="crud_controls">
        ...
        <a href="<?php echo site_url( $_directory . "controls/add" );?>" data-operationid="managedonationprojectsadd">
        	<input data-operation="add" type="button" class="btn btn-warning btn-flat submit_btn_form" value="<?php echo lang_line("text_add");?>"  />
        </a>
        <input data-operation="delete" data-operationid="managedonationprojectsdelete" type="button" class="btn btn-danger btn-flat submit_btn_form" value="<?php echo lang_line("text_delete");?>" />
        
        
        <a href="javascript:;" data-operationid="managedonationprojectsupdatesorting">

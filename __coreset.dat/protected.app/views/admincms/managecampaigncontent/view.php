    ...
    <table id="tbl_records" class="table table-bordered table-striped">
        <thead>
            <tr>
                ...
                <th style="width:10px" >Add Donor</th>
            </tr>
        </thead>
            ...
            foreach ( $table_record -> result_array() as $key => $row )
            {
                ...
                ?>
                    <tr>
                        ...
                        <td><?php echo $controller->amountReceived($row["donation_project_id"], $row["id"]);?></td>
                        ...
                        <td>
                        <a href="<?php echo site_url( $_directory_adddonor . "controls/add/" . $row["id"] );?>" data-operationid="managecampaigncustomdonoradd">
                            <input data-operation="add" type="button" class="btn btn-warning btn-flat submit_btn_form" value="Add Donor"  />
                        </a>
                        </td>
                    </tr>
                <?php
...
?>
    ...
    <div class="crud_controls">
        ...
        <a href="<?php echo site_url( $_directory . "controls/add" );?>" data-operationid="managedonationcampaignsadd">

            ...
            foreach ( $table_record -> result_array() as $key => $row )
            {
                ...
                ?>
                    <tr>
                        ...
                        <td>
                        <a href="<?php echo site_url( $_directory . "controls/edit/" . $row["id"]);?>" data-operationid="managechapterpersonsdesignationedit">
...
?>
    ...
    <div class="crud_controls">
        ...
        <a href="<?php echo site_url( $_directory . "controls/add" );?>" data-operationid="managechapterpersonsdesignationadd">
        	<input data-operation="add" type="button" class="btn btn-warning btn-flat submit_btn_form" value="<?php echo lang_line("text_add");?>"  />
        </a>
        <input data-operation="delete" data-operationid="managechapterpersonsdesignationdelete" type="button" class="btn btn-danger btn-flat submit_btn_form" value="<?php echo lang_line("text_delete");?>" />
        
        
        <a href="javascript:;" data-operationid="managechapterpersonsdesignationupdatesorting">

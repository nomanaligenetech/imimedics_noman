...
<input type="hidden" name="id" value="<?php echo set_value('id', $id); ?>" />
  <input type="hidden" name="options" value="<?php echo set_value('options', $options); ?>" />
    ...
    <div class="crud_controls">
        <button type="submit" data-operationid="managechapterpersonsdesignationsave" class="btn btn-warning btn-flat"><?php echo lang_line("text_save");?></button>
        <a class="btn btn-danger btn-flat" data-operationid="managechapterpersonsdesignationview" href="<?php echo site_url( $_directory . "controls/view");?>">

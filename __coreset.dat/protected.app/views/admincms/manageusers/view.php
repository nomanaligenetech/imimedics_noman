<a href="<?php echo site_url( $_directory . "controls/export")?>" class="btn btn-primary" style="margin-bottom:15px;">Export Users</a>
<?php 
...
<script>
    ...
    var tbl_records_serverside_additional_options = {
        'columnDefs': [{
            'orderable': false,
            'aTargets': [
                7, // Make the "Paid Membership Status" column un-sortable (as it is computed in PHP and can't be correctly sorted in the SQL unless the computation is implemented within the DB).
            ],
        }],
    };
</script>

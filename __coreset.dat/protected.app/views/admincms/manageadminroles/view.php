            ...
            foreach ( $table_record -> result_array() as $key => $row )
            {
                ...
                ?>
                    <tr>
                        ...
                        <td>
                        <a href="<?php echo site_url( $_directory . "controls/edit/" . $row["id"]);?>" data-operationid="manageadminrolesedit">
...
?>
    ...
    <div class="crud_controls">
        ...
        <a href="<?php echo site_url( $_directory . "controls/add" );?>" data-operationid="manageadminrolesadd">
        	<input data-operation="add" type="button" class="btn btn-warning btn-flat submit_btn_form" value="<?php echo lang_line("text_add");?>"  />
        </a>
        <input data-operation="delete" data-operationid="manageadminrolesdelete" type="button" class="btn btn-danger btn-flat submit_btn_form" value="<?php echo lang_line("text_delete");?>" />

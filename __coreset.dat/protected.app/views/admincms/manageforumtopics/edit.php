           ...
           <td class="td_bg">Forum <?php echo required_field();?></td>
              <td colspan="2" class="td_bg">
                ...
                <div class="input-group">
                    <?php echo form_dropdown('forum', DropdownHelper::forum( set_value("id", "$id") ), 
											set_value("id", $id), 
										"class='form-control '" )?>
                </div>
                </td>
...
<input type="hidden" name="id" value="<?php echo set_value('id', $id); ?>" />
  ...
  <button type="submit" class="btn btn-warning btn-flat" data-operationid="manageforumtopicssave"><?php echo lang_line("text_save");?></button>
        <a class="btn btn-danger btn-flat" data-operationid="manageforumtopicsview" href="<?php echo site_url( $_directory . "controls/view");?>">

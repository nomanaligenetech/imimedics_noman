...
?>    
	...
	<table class="table table_form">
	 ...
	 <tr>
           <td class="td_bg">Forum <?php echo required_field();?></td>
              <td colspan="2" class="td_bg">
              
                <div class="input-group">
                    <?php echo form_dropdown('forum', DropdownHelper::forum( set_value("Select Forum", "")), 
											set_value("id", $id), 
											"class='form-control '" )?>
                </div>
	   	...
	   	<tr>
           <td class="td_bg">Topic <?php echo required_field();?></td>
              <td colspan="2" class="td_bg">
              
                <div class="input-group targetBox_topicarea" >
                    <?php
				if ( empty( $ajax_output1 ) )
				{
				?>
					<small class="badge pull-right bg-green" style="">please select topics</small>
                <?php
				}
				else
				{
  ...
  <input type="hidden" name="options" value="<?php echo set_value('options', $options); ?>" />
   ...
   <button type="submit" data-operationid="managepostssave" class="btn btn-warning btn-flat"><?php echo lang_line("text_save");?></button>
        <a class="btn btn-danger btn-flat" data-operationid="managepostsview" href="<?php echo site_url( $_directory . "controls/view");?>">

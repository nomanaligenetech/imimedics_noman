...
<input type="hidden" name="id" value="<?php echo set_value('id', $id); ?>" />
  ...
  <button type="submit" data-operationid="whojoineventssave" class="btn btn-warning btn-flat"><?php echo lang_line("text_save");?></button>
        <a class="btn btn-danger btn-flat" data-operationid="whojoineventsview" href="<?php echo site_url( $_directory . "controls/view");?>">

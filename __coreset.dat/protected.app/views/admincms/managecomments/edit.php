...
?>    
	...
	<table class="table table_form">
	 	<tr>
		  <td class="td_bg fieldKey">Comment <?php echo required_field(); ?></td>
		  <td class="td_bg fieldValue" colspan="2">
          <div class="input-group">
		    <?php
		    $specdata		= array("name"			=> "comment",
									"id"			=> "comment",
									"rows"			=> 10,
									"cols"			=> 70,
...
<input type="hidden" name="id" value="<?php echo set_value('id', $id); ?>" />
 ...
 <div class="crud_controls">
  <button type="submit" data-operationid="managecommentssave" class="btn btn-warning btn-flat"><?php echo lang_line("text_save");?></button>
        <a class="btn btn-danger btn-flat" data-operationid="managecommentsview" href="<?php echo site_url( $_directory . "controls/view");?>">

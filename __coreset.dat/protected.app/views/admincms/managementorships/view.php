            ...
            foreach ($table_record->result_array() as $key => $row) {
                ...
                ?>
                    <tr>
                        ...
                        <td>
                        <a href="<?php echo site_url($_directory . "controls/edit/" . $row["id"]); ?>" data-operationid="managementorshipsedit">
...
<div class="crud_controls">
        ...
        <input data-operation="delete" data-operationid="managementorshipsdelete" type="button" class="btn btn-danger btn-flat submit_btn_form" value="<?php echo lang_line("text_delete"); ?>" />
    </div>
<?php
echo form_close();
?>
<?php
$DD_EB_RG								= DropdownHelper::short_conferenceprice_earlybird_regular_dropdown(TRUE, FALSE );

if ($fetch_records_for_view_ROW["parentid"] == 0) 
{
	$screen_two_details 		= $this->queries->fetch_records("short_conference_registration_screen_two_details", " AND parentid = '". $fetch_records_for_view_ROW["screen_two_id"] ."' ");
?>
 <small>
			...
			?>
				<tr>
					<td width="200px;">
                        ...
                        <em style="text-decoration:underline;"><?php
						if($std['addon'] == 1){
							?>

            ...
            {						
                ...
                ?>
                    <tr>
                        ...
                        <td><?php echo $row['VIEW_region_name'];?></td>
                        <td><?php echo $row['VIEW_package_name'];?></td>
                        
                        <td><?php echo $row['VIEW_total_price'];?></td>
                        <td><?php echo $row['VIEW_total_paid'];?></td>
                        <td><?php echo $row['VIEW_cash_on_site'];?></td>
                        
                        <td><?php echo $row['VIEW_is_abstract_submitted'];?></td>

<div style="font-size:13px;">
    ...
    <p style=" <?php echo $emailTemplateHelper->styles("p");?> ">
        Stage 3 send to <b><?php echo $name;?></b>. Below are the details.
    </p>
                ...
                <td>
                    ...
                    <div class="main" style="font-family:arial;text-align:left;">
                        ...
                        <table  class="rooms_details" cellpadding="5" style="border:1px solid #c4c4c4; width:100%; font-size:12px;">
                            ...
                            <tr>
                                <td height="20" colspan="2" align="left" valign="middle" bgcolor="#465056" class="heading" style="color: #FFF">Stage 3 Details: </td>
                                
                                <td><?php echo str_replace('[stage3_link]',$email_post['stage3_link'],$email_post['stage3_details']);?></td>
                          	</tr>

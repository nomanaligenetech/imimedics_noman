<div style="font-size:13px;">
    ...
    <p style=" <?php echo $emailTemplateHelper->styles("p");?> ">
        Interviewer updated interview notes for Applicant <b><?php echo $name;?></b> . Below are the details.
    </p>
                ...
                <td>
                    ...
                    <div class="main" style="font-family:arial;text-align:left;">
                        ...
                        <table  class="rooms_details" cellpadding="5" style="border:1px solid #c4c4c4; width:100%; font-size:12px;">
                            ...
                            <tr>
                            	<td height="20" colspan="2" align="left" valign="middle" bgcolor="#465056" class="heading" style="color: #FFF">Recommend ? </td>
                                <td><?php echo $email_post['interview_recommendation']; ?></td>
                          	</tr>
                            
                            <tr>
                            	<td height="20" colspan="2" align="left" valign="middle" bgcolor="#465056" class="heading" style="color: #FFF">Interview Notes: </td>
                                <td><?php echo $email_post['interview_notes']; ?></td>
                            </tr>

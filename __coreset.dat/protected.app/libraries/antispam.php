...
class Antispam {
	...
	*/
	...
	var $char_length 	= 	9;		// CODE_CHARS_COUNT
	
	var $char_color 	=   "#8b8b8b,#8b8b8b,#8b8b8b,#8b8b8b,#8b8b8b,#8b8b8b,#8b8b8b";  // CODE_CHAR_COLORS
	var $char_colors	= 	array();  // array from $char_color
	
	
	var $line_count		=	3;		// CODE_LINES_COUNT
	var $line_color		=  "#565656,#565656,#565656,#565656,#565656,#565656,#565656"; 	// CODE_LINE_COLORS
	...
	function get_antispam_image( $override = array() ) {
		...
		$img_markup = '<img src="' . $this->img_url . $img_name . '" width=" ' . $this->img_width
					. '" height="' . $this->img_height . '" style="border:1px solid #cccccc;" alt=" " />';

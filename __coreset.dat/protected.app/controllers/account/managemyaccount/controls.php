...
class Controls extends C_frontend {
	...
	public function _create_fields_for_form( $return_array = false, &$data, $db_data = array() )
	{
		...
		$empty_inputs				= array( "id", "name", "last_name", "email", "password", "registration_site", "activation_code", "is_active", "date_added|default_date",  "options", "unique_formid" );
		
		$filled_inputs				= array( "id", "name", "last_name", "email", "password", "registration_site", "activation_code", "is_active", "date_added", "options", "unique_formid" );

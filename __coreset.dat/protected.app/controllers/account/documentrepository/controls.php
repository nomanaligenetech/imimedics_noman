...
class Controls extends C_frontend {
	...
	public function __construct()
	{
		...
		$this->data["_heading"]										= 'Document Repository';
	...
	{		
		...
		$data['conference_registration_excel_documents']			= $this->imiconf_queries->fetch_records_imiconf("conference_registration_excel_documents", 
		...
		#die;
		if ( $data['conference_registration_excel_documents'] -> num_rows() <= 0 )
		{

...
include( APPPATH . 'controllers/admincms/manageforum/control_includes.php' );
class Controls extends Controls_Include {
	...
	public function __construct()
	{
		...
		$this->data["_heading"]										= 'Manage Forum';
	...
	{
		$tmp["tr_heading"]											= array('Name','Slug','Date','Created By','Topic');
	...
	public function view( $is_ajax = 0 )
	{
		...
		$data["table_record"]										= $this->queries->fetch_records("forum", " ORDER BY id desc ");
	...
	public function edit( $edit_id )
	{
		...
		$edit_details												= $this->queries->fetch_records("forum", " AND id = '$edit_id' ");

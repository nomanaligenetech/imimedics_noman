...
include( APPPATH . 'controllers/admincms/manageposts/control_includes.php' );
class Controls extends Controls_Include {
	...
	public function __construct()
	{
		...
		$this->data["_commentdir"]									="admincms/managecomments/";
		...
		$this->data["_heading"]										= 'Manage Posts';
	...
	{
		$tmp["tr_heading"]											= array('Post Name','Slug','Date','Created By','comments');
	...
	$data["table_record"]										= $this->queries->fetch_records("posts", " AND topic_id=$is_ajax ORDER BY id desc ");
    ...
    $data["table_record"]										= $this->queries->fetch_records("posts", " ORDER BY id desc ");
	$data["table_properties"]									= $this->view_table_properties();
	...
	public function edit( $edit_id )
	{
		...
		$edit_details												= $this->queries->fetch_records("posts", " AND id = '$edit_id' ");

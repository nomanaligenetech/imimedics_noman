...
include( APPPATH . 'controllers/admincms/manageforumtopics/control_includes.php' );
class Controls extends Controls_Include {
	...
	public function __construct()
	{
		...
		$this->data["_heading"]										= 'Manage Forum Topics';
	...
	{
		$tmp["tr_heading"]											= array('Topic Name','Forum Name','Slug','Date','Created By','View Post');
	...
	$data["table_record"]										= $this->queries->fetch_records("formtopics", " AND frmid=$is_ajax ORDER BY id desc ");
    ...
    $data["table_record"]										= $this->queries->fetch_records("formtopics", " ORDER BY id desc ");
    //echo $this->db->last_query(); die();
	...
	public function edit( $edit_id )
	{
		...
		$edit_details												= $this->queries->fetch_records("formtopics", " AND id = '$edit_id' ");

...
include( APPPATH . 'controllers/admincms/managecategory/control_include.php' );
class Controls extends Controls_Include {
	...
	public function __construct()
	{
		...
		$this->data["_heading"]										= 'Manage Category';
	...
	{
		$tmp["tr_heading"]											= array('Category Type','Category Name', 'Slug', 'Sort' );
	...
	public function view( $is_ajax = 0 )
	{
		...
		//$data["table_record"]										= $this->queries->fetch_records("category", " ORDER BY id desc");
		...
		$extra_select 									= " *,	
															  (SELECT cat_type_name FROM tb_category_type WHERE id = tb_category.type_id) as cat_type_name";
	...
	public function edit( $edit_id )
	{
		...
		$edit_details												= $this->queries->fetch_records("category", " AND id = '$edit_id' ");

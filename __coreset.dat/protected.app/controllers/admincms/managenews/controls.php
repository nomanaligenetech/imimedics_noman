...
include( APPPATH . 'controllers/admincms/managenews/control_includes.php' );
class Controls extends Controls_Include {
	...
	public function __construct()
	{
		...
		$this->data["_heading"]										= 'Manage News';
		$this->data["_pagetitle"]									= $this->data["_heading"] . " - ";
		$this->data['_pageview']									= $this->data["_directory"] . "view.php";
		
		
		$this->data["pdf_types"]									= "pdf";
		$this->data["video_types"]									= "mp4|avi|mov";
	    $this->data["pdfs_dir"]	 								    = "./assets/files/news_pdf/";
		$this->data["videos_dir"]	 								= "./assets/files/news_videos/";
	...
	{
		$tmp["tr_heading"]											= array('News','date','slug');
	...
	public function view( $is_ajax = 0 )
	{
		...
		$data["table_record"]										= $this->queries->fetch_records("news", " ORDER BY id desc ");
	...
	public function edit( $edit_id )
	{
		...
		$edit_details												= $this->queries->fetch_records("news", " AND id = '$edit_id' ");
		...
		$data['pdf']												= $this->queries->fetch_records("news_pdf", " AND parentid = '$edit_id' ");		
		
		$data['videos']												= $this->queries->fetch_records("news_videos", " AND parentid = '$edit_id' ");		

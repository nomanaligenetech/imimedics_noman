...
include( APPPATH . 'controllers/admincms/whojoinevents/control_includes.php' );
...
*/
		...
		$this->data["_heading"]										= 'Who Join Event';
	...
	{
		$tmp["tr_heading"]											= array('User Name','User Email','Event','Event Date','Joining Date','Decision');
	...
	public function view( $is_ajax = 0 )
	{
		...
		$data["table_record"]										= $this->queries->fetch_records("whojoinevents", " ORDER BY id desc ");

...
class Controls extends C_admincms {
	...
	public function __construct()
	{
		...
		$this->data["_heading"]										= 'Manage Chapter Persons (Boards)';
	...
	public function view( $is_ajax = 0 )
	{
		...
		$data["table_record"]										= $this->queries->fetch_records("boards", " ORDER BY id desc ");
	...
	public function ajax_update_sorting( $id )
	{
		...
		foreach ($id	as $key	=> $result)
		{
			...
			$this->queries->SaveDeleteTables($saveData, 'e', "tb_boards", 'id') ;
		}
	...
	public function save ()
	{
		...
		else
		{
			...
			{
				$this->queries->SaveDeleteTables($saveData, 's', "tb_boards", 'id');  		
	...
	public function edit( $edit_id )
	{
		...
		$edit_details												= $this->queries->fetch_records("boards", " AND id = '$edit_id' ");
	...
	public function delete( $id )
	{
		...
		{
			$saveData['id']									= $result;	
			$this->queries->SaveDeleteTables($saveData, 'd', "tb_boards", 'id') ;
		}

...
class Controls_Include extends C_admincms {
	...
	public function delete( $THIS, $id )
	{
		...
		{
			$saveData['id']									= $result;	
			$THIS->queries->SaveDeleteTables($saveData, 'd', "tb_pressrelease", 'id') ;
		}
	...
	public function _create_fields_for_form( $return_array = false, &$data, $db_data = array() )
	{
	    ...
	    $empty_inputs				= array( "id","name","pressreleas_date","description","slug","pressrelease_pdf","options");
		
		$filled_inputs				= array( "id","name","pressreleas_date","description","slug","pressrelease_pdf","options");
